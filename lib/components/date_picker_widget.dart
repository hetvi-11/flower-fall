import 'package:flower_fall/components/date_widget.dart';
...
class AppColors {
  ...
  static const Color defaultDateColor = Color(0xFF9E9E9E);
  static const Color defaultDayColor = Color(0xFF9E9E9E);
  static const Color defaultMonthColor = Colors.black;
  static const Color defaultSelectionColor = Color(0xFF95E7E9);
  static const String defaultSelectionImage ='images/SpringCompressed.jpg';
  static  const Color defaultDeactivatedColor = Color(0xFF9E9E9E);
}

class Dimen {
  Dimen._();

  static const double dateTextSize = 30;
...
BoxDecoration customDecoration = BoxDecoration(
    image: DecorationImage(
      image: AssetImage('${AppColors.defaultSelectionImage}'),
...
class DatePicker extends StatefulWidget {
  ...
  DatePicker(
      this.startDate, {
        ...
        this.selectionImage = AppColors.defaultSelectionImage,
...
//            print("Inside Inactive dates.");
          ...
          return DateWidget(
            ...
            selectionImage: widget.selectionImage,
